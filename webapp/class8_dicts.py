...
Trucking_genre = {'table': 'Orders',
                  ...
                  'table_filters': [{'Shipper Filter': ['get_Shippers', 'Show All']},
                                    {'Date Filter': ['Last 60 Days', 'Last 120 Days', 'Last 360 Days', 'Last Year', 'This Year', 'Show All']},
...
Orders_setup = {'name' : 'Trucking Job',
                ...
                'entry data': [['Jo', 'JO', 'JO', jobcode, 'text', 0, 'ok', 'cc', None, 'Always'],
                               ...
                               ['Container', 'Container', 'Container', 'text', 'concheck', 0, 'ok', 'cc', None, 'Job'],
                                ['BOL', 'In-Book', 'In-Book', 'text', 'release', 0, 'ok', 'cc', None, 'Gate'],
                               ['Chassis', 'Chassis', 'Chassis', 'text', 'text', 0, 'ok', 'cc', None, 'Job'],
                                ...
                                ['Date4', '1st Call', '1st Call', 'date', 'date', 0, 'ok', 'cc', None, 'Dispatch'],
                                ['Date5', '2nd Call', '2nd Call', 'date', 'date', 0, 'ok', 'cc', None, 'Dispatch'],
                                ['Date6', '3rd Call', '3rd Call', 'date', 'date', 0, 'ok', 'cc', None, 'Dispatch'],
