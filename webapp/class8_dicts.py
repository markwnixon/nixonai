...
Trucking_genre = {'table': 'Orders',
                  ...
                  'task_boxes': [{'Adding': ['New Job', 'New Customer', 'New Interchange', 'New Service', 'New From Copy',
                                             'New Manifest', 'Upload Source', 'Upload Proof', 'Upload 2nd Proof', 'Upload RateCon', 'Make Blended Gate', 'New Terminal', 'New Driver', 'New Asset']},
                  ...
                  'container_types': ['40\' GP 9\'6\"', '40\' RS 9\'6\"', '40\' GP 8\'6\"', '40\' RS 8\'6\"', '40\' FR',
                                      ...
                                      '53\' Dry', 'LCL', 'RORO'],
                  'truck_types' : ['Tractor', 'Chassis', 'Trailer'],
                  ...
                  'delivery_types': ['Hard Time', 'Soft Time', 'Day Window', 'Upon Notice', 'Appt Required', 'Placeholder'],
...
'New Driver' : ['Table_Selected', 'New', 'Drivers'],
'New Asset' : ['Table_Selected', 'New', 'Trucks']
                                         },
                                    ...
                                    'Tasks':
                                        {
                                          ...
                                          'Update Emails': ['Single_Item_Selection', 'Update_Emails', ''],
                                          'Update RC Needed': ['Single_Item_Selection', 'Update_RC_Needed', '']
                                        }
...
['DrvProof', 'DP', 'Proof', 'text', None, 0, 'ok', 'cL', None, 'Docs'],
['DrvSeal', 'DS', 'Proof', 'text', None, 0, 'ok', 'cL', None, 'Docs'],
                              ...
                              # ['Date3', 'Third Date', 'Third Date', 'appears_if', 'HaulType', 0, 'ok', 'cc', None, 'Job Detail'],
                                ['RCneeded', 'RC Needed', 'Rate Con Needed', 'select', 'rc_needed_flags', 0, 'ok', 'cc', None, 'Job'],
                                ['RCAmount', 'RC$', 'Rate Con Amount', 'text', 'text', 0, 'ok', 'cr', None, 'Job'],
                ...
                'ncdefaults': [
                                ...
                                ['HoldType', ''],
                                ['Description', ''],
                                ['InvoTotal', None], ['InvoDate', None], ['PaidDate', None], ['PaidAmt', None], ['PayRef', None], ['PayMeth', None], ['PayAcct', None], ['BalDue', None], ['Payments', None],
                                ['Delivery',None], ['Scache', 1], ['Pcache', 1], ['Icache', 1], ['Mcache', 1], ['Pkcache', 1], ['Date4',None], ['Date5',None], ['Date6',None], ['Rcache', 1], ['Pcache2',None],
                                ['Date7',None], ['Date8',None], ['DrvProof',None], ['DrvSeal',None], ['D1cache',None], ['D2cache',None], ['HoldType',None]
                            ],
                ...
                'side data': [{'customerdata': ['People', [['Ptype', 'Trucking']], 'Company']},
                              ...
                              {'truckdata': ['Vehicles', [['Active', 1],['Type', 'Tractor']], 'Unit']},
...
Interchange_setup = {'name' : 'Interchange Ticket',
                     ...
                     'entry data': [['Jo', 'JO', '', '', None, 0, 'ok', 'cc', None, 'Always'],
                                    ...
                                    ['Time', 'Gate Time', 'Gate Time', 'text', 'text', 0, 'ok', 'cc', None, 'Ticket'],
                                    ...
                                    ['PortHours', 'Port Minutes', 'Port Minutes', 'text', 'integer', 0, 'ok', 'cc', None, 'Extras']
                                    ],
                     'hidden data' : [],
                     'haulmask' : [],
                     'colorfilter': ['Status'],
...
Customers_setup = {'name' : 'Customer',
                   ...
                   'entry data': [['Company', 'Company/Name', 'Company/Name', 'text', 'text', 0, 'ok', 'cl', None, 'Always'],
                                ...
                                ['NoProofNeeded', 'No Proof', 'No Proof Needed', 'select', 'no_proof_options', 0, 'ok', 'cc', None, 'Always'],
...
Drivers_setup = {'name' : 'Drivers',
                 ...
                 'filterval': None,
                  'checklocation': 1,
                  'creators': [],
                  'table_adds': ['Driver CDL', 'Driver MED', 'Driver TWIC'],
                  'ukey': 'Name',
                  'simplify': [],
...
['CDLpdf', 'DL', 'Compliance', 'text', None, 0, 'ok', 'cL', None, 'Always'],
['MEDpdf', 'MD', 'Compliance', 'text', None, 0, 'ok', 'cL', None, 'Always'],
['TWICpdf', 'TW', 'Compliance', 'text', None, 0, 'ok', 'cL', None, 'Always'],
...
['Type', 'Type', 'Select Type', 'select', 'truck_types', 0, 'ok', 'cc', None, 'Always'],
...
['Regpdf', 'RG', 'Compliance', 'text', None, 0, 'ok', 'cL', None, 'Always'],
['Titpdf', 'TI', 'Compliance', 'text', None, 0, 'ok', 'cL', None, 'Always'],
                                    ...
                                    'Quick' :
                                        {
                                            ...
                                            'Edit Item' : ['Single_Item_Selection', 'Edit', 'Form'],
                                            'Invoice Upload' : ['Single_Item_Selection', 'Upload', 'Invoice'],
...
OverSeas_setup = {'name' : 'Freight Forwarding Job',
                ...
                'entry data': [['Jo', 'JO', 'JO', forwardingcode, 'text', 0, 'ok', 'cc', None, 'Always'],
                               ...
                               ['Istat', 'Istat', 'Invoice Status', 'text', None, 0, 'ok', 'cc', None, 'Always'],
                ...
                'form checks': {
                   'New': ['Shipper', 'Exporter', 'Consignee', 'FrFor', 'Booking'],
                   'Edit': ['Shipper', 'Exporter', 'Consignee', 'FrFor', 'Booking']
                },
                'jscript': 'dtTrucking',
                'documents': ['Invoice'],
...
Billing_genre =   {'table': 'Bills',
                  ...
                  'paymethods': ['Cash', 'Check', 'Credit Card', 'Debit Card', 'Epay-App', 'Epay-Web', 'PayCargo', 'ACH', 'Wire'],
                  'acctcategories': ['Direct', 'Indirect', 'G-A', 'Holding'],
...
Bills_setup = {'name' : 'Billing',
                ...
                'side data': [{'vendordata': ['People', [['Ptype', 'Vendor']], 'Company']},
                              ...
                              {'expdata': ['Accounts', [['Co', 'K'],['Type','Expense']], 'Name']},
...
Accounts_setup = {'name' : 'Account',
                   ...
                   'entry data': [['Name', 'Account Name', 'Account Name', 'text', 'text', 0, 'ok', 'cl', None, 'Always'],
                                  ...
                                  ['Taxrollup', 'Taxrollup', 'Select Tax Line', 'select', 'taxdata', 0, 'ok', 'cc', None, 'Always'],
                   ...
                   'colorfilter': None,
                    ...
                    'side data': [{'accttypes': ['Accttypes', [['Name', 'All']], 'Name']},
                                  {'codata': ['Divisions', [['Name', 'All']], 'Co']},
                                  {'taxdata': ['Taxmap', [['Name', 'All']], 'Name']}
                              ],
                    'default values': [{'get_Shipper': 'Fill This Later'}, {'get_Taxrollup': 'Advertising'}],
                    'form show': {
                        'New': [],
                        'Edit': []
                    },
