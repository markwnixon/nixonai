...
def initialize_invoice(myo):
    ...
    if ldat is not None:
        ...
        if bid:
            ...
            input = Invoices(Jo=myo.Jo, SubJo=None, Pid=0, Service=mys.Service, Description=descript,
...
def update_invoice(jo):
    ...
    if ldat is None:
        ...
        docfile = make_invo_doc(yo, ldata, pdata1, pdata2, pdata3, cache, invodate, 0)
        if cache > 1:
